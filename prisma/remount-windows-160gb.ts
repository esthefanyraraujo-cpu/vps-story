...
async function main() {
  ...
  console.log(`Remontando a ISO do Windows Server 2022 no servidor de 160GB (${serverId})...`)
  ...
  console.log('Agora você pode clicar em "Next" no console de 160GB para iniciar a instalação.')
}
